  ...
  return (
    <div className="mx-auto text-center">
      ...
      <div className="flex justify-center flex-col gap-4 py-4">
        ...
        <Link to='/inputField'><Button className="border-2 border-green-600 text-green-600 rounded-3xl py-2 px-6 hover:bg-green-600 hover:text-white transition-all">Controlled Input Field</Button></Link>
      </div>
    </div>
  )
}
